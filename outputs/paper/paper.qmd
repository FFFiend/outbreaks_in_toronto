...
# Data 
The outbreak data is from "Outbreaks in Toronto Healthcare Institutions" on the Open Data Toronto website [@citeopentoronto]. 
...
ggplot(covid_data, aes(x = format(Date.Outbreak.Began, "%m"), fill = Causative.Agent.1)) +
  geom_bar(stat = "count") +
  labs(title = "Figure 2: Number of COVID-19 Cases Over Months in 2023",
       x = "Month",
       y = "Number of Cases") +
...
ggplot(data_filtered, aes(x = month, fill = `Causative.Agent.1`)) +
  geom_bar() +
  labs(title = "Cases per Month and Disease (Feb to Aug 2023)",
       x = "Month",
       y = "Number of Cases") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),legend.position="none")

```
It can be seen that even among months where COVID-19 was seemingly not spiking (i.e in the middle of the year) it still made up the majority percentage of all outbreaks within those months.
